    ...
    <div className='manuals'>
      ...
      <div className='image-div-holder'>
        <div className='image-div-parts'>
          <img className='manual-parts-img' alt='' src={lampParts} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>1</h1>
          <img className='guide-img' alt='' src={lampGuideStanding} />
          <img className='manual-img' alt='' src={part1} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>2</h1>
          <img className='guide-img' alt='' src={lampGuideStanding} />
          <img className='manual-img' alt='' src={part2} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>3</h1>
          <img className='guide-img' alt='' src={lampGuideStanding} />
          <img className='manual-img' alt='' src={part3} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>4</h1>
          <img className='guide-img' alt='' src={lampGuideStanding} />
          <img className='manual-img' alt='' src={part4} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>5</h1>
          <img className='guide-img' alt='' src={lampGuideHanging} />
          <img className='manual-img' alt='' src={part5} />
        </div>
        <div className='image-div'>
          <h1 className='part-number'>6</h1>
          <img className='guide-img' alt='' src={lampGuideHanging} />
          <img className='manual-img' alt='' src={part6} />
        </div>
        <div className='image-div' id='night-background'>
          <h1 className='part-number'>7</h1>
          <img className='guide-img' alt='' src={lampGuideHanging} />
          <img className='manual-img' alt='' src={part7} />
        </div>
      </div>
    </div>
  );
