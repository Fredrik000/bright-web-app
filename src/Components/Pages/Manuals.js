      ...
      <div>
        ...
        <div className='image-div-holder'>
          <div className='image-div-parts'>
            <img className="manual-parts-img" src={lampParts} />
          </div>
            <div className='image-div'>
                <h1 className="part-number">1</h1>
                <img className="guide-img" src={lampGuideStanding}/>
                <img className="manual-img" src={part1} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">2</h1>
                <img className="guide-img" src={lampGuideStanding}/>
                <img className="manual-img" src={part2} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">3</h1>
                <img className="guide-img" src={lampGuideStanding}/>
                <img className="manual-img" src={part3} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">4</h1>
                <img className="guide-img" src={lampGuideStanding}/>
                <img className="manual-img" src={part4} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">5</h1>
                <img className="guide-img" src={lampGuideHanging}/>
                <img className="manual-img" src={part5} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">6</h1>
                <img className="guide-img" src={lampGuideHanging}/>
                <img className="manual-img" src={part6} />
            </div>
            <div className='image-div'>
                <h1 className="part-number">7</h1>
                <img className="guide-img" src={lampGuideHanging}/>
                <img className="manual-img" src={part7} />
            </div>
        </div>
